...
const hr = {
  ...
  hero: {
    ...
    cta2: "Naši projekti",
    trustedBy: "AI rješenja stručnjaka za digitalni marketing",
    sectors: "automatizacija · sadržaj · chatbotovi · web",
  ...
  contact: {
    ...
    details: [
      {
        label: "E-pošta",
        value: "automation.aiva@gmail.com",
        href: "mailto:automation.aiva@gmail.com",
      },
      {
        label: "Uvodni poziv",
  ...
  form: {
    ...
    errorSend:
      "Slanje poruke nije uspjelo. Molimo kontaktirajte nas direktno na automation.aiva@gmail.com.",
